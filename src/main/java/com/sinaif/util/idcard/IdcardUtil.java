...
public class IdcardUtil {
    ...
    static {
        ...
        try {
            InputStream is = IdcardUtil.class.getResourceAsStream("/idcard/province.txt");
            String p = FileUtil.getStringFromStream(is);
            provice = init(p);
            is = IdcardUtil.class.getResourceAsStream("/idcard/city.txt");
            p = FileUtil.getStringFromStream(is);
            city = init(p);
            is = IdcardUtil.class.getResourceAsStream("/idcard/area.txt");
            p = FileUtil.getStringFromStream(is);
            area = init(p);
        } catch (Exception e) {
            e.printStackTrace();
